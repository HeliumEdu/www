...
Class Schedule items appear on the Planner only when the class has a schedule. See [Class Meeting Schedules](/support/classes/class-meeting-schedules/) for setting up class meeting days and times.
