...
Push reminders require notifications to be enabled for Helium on the intended device. When you first use Push, your device or browser may prompt you to allow notifications. If you previously declined, re-enable them in your device's system settings (or your browser's site settings for web), then reopen Helium.
...
### Emails Do Not Appear in the Notification Center
