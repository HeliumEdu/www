...
To avoid re-configuring the same type and offset every time, set the defaults under the **Reminders** section of [**Settings → Preferences**](https://app.heliumedu.com/settings/preferences) to control what is pre-filled on each new reminder:
