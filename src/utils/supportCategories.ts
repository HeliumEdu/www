...
export const SUPPORT_CATEGORIES: SupportCategory[] = [
  ...
  { slug: 'resources', title: 'Resources', description: 'Organize study materials and reference links.', icon: 'tabler:book' },
  { slug: 'notebook', title: 'Notebook', description: 'Rich notes linked to your classes and assignments.', icon: 'tabler:notebook' },
